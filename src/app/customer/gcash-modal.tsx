...
export default function GCashPayment({
  ...
  const handleSubmit = async () => {
    if (validateForm()) {
      ...
      if (!error) {
        ...
        await createClient().from("appointments").update({ is_paid: "Paid" }).eq("id", appointmentId);
  ...
  return (
    <div
      className="h-full overflow-y-auto absolute inset-0 bg-black/50 flex items-center justify-center z-50 p-4"
      onClick={onClose}
    >
      <div
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <p className="text-sm text-blue-800 leading-relaxed">
              Transfer the amount to the GCash account below, then enter the
              payment details here to confirm your transaction.
            </p>
          </div>
